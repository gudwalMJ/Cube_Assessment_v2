  ...
  return (
    <main>
      ...
      <p>
        ...
        exercise is to assess your general skill level and give us something to
        talk about at our next appointment.
      </p>
      <section>
        <h3>What this app should do</h3>
        <p>
          SlapSticker is an app that lets users slap stickers on their face
          using their webcam. Functionality-wise, the app works, but the UI
          needs some love. We'd like for you to extend this prototype to make it
          look and feel a bit better.
        </p>
      ...
      <section>
        ...
        <p>
          Of course, we didn't expect you to build a full-fledged app in such a
        ...
        <ul>
          ...
          <li>Add super cool effects to the webcam feed</li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Run `$ npm run start` to start the dev environment</li>
